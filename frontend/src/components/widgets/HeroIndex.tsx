...
export function HeroIndex({ repoId }: { repoId: string | undefined }) {
  ...
  const history = useScoreHistory(repoId, 30);
      ...
      <div className="grid gap-7 lg:grid-cols-[minmax(260px,360px)_1fr] lg:gap-9">
            ...
            <div className="mt-6">
              ...
              <div className="mt-4 flex flex-wrap items-center gap-2.5">
                ...
                >
                  ...
                  <span className="text-ink-mute">30d</span>
                </span>
        ...
        <div className="flex flex-col">
          <div className="mb-1 flex items-center justify-between">
            ...
            <span className="text-[11px] text-ink-mute">avg health per day · last 30d</span>
          </div>
          {history.isLoading ? (
            ...
            <Lollipop points={points} height={210} />
          )}
        </div>
      </div>
    </Card>
